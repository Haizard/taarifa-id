...
const schema = z
  ...
  .refine(
    (d) => {
      if (d.nationality === "Tanzanian") return !!d.nidaNumber?.trim();
      return true;
    },
  ...
  .refine(
    (d) => {
      if (d.nationality === "Foreigner") return !!d.passportNumber?.trim();
      return true;
    },
      ...
      {step === 2 && (
        <>
          ...
          <div className="bg-blue-50 dark:bg-blue-950 rounded-xl p-3 text-xs text-blue-700 dark:text-blue-300">
            ...
            You will need it to complete your first login.
          </div>
