    ...
    <footer className="bg-gray-900 text-gray-400 py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              Tanzania&apos;s digital identity and emergency profile platform.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              {["Individual", "Family", "School", "Business", "Institution"].map((t) => (
                <li key={t}>
                  <Link href={`/register?type=${t}`} className="hover:text-white transition-colors">
                    {t}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs">
          ...
          <p>
            Designed & Built by{" "}
            <a href="#" className="text-blue-400 hover:text-blue-300">Sunriver Systems</a>
          </p>
        </div>
      </div>
    </footer>
